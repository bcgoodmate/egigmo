...
class CreateFormsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('forms', function (Blueprint $table) {
            ...
            $table->decimal('probability', 8, 2)->nullable(); // default probability
            $table->decimal('amount', 8, 2)->nullable(); // the estimated value of this sale opportunity
            ...
            $table->uuid('send_autoresponder_id');
            $table->timestamps();
            $table->softDeletes();
        });
    }
